...
> 형식·규칙: `~/.claude/verification/templates.md`, 프로젝트 값: 루트 `CLAUDE.md` "검증 설정".

| 일자 | 기록 | 유형 | 우선순위 | 판정 |
|---|---|---|---|---|
| 2026-09-21 | [account D 구현 — 로그인 로그 IP·초대코드 만료·취소·jjwt](records/2026-09-21_account-d.md) | 수정 | P1 | 조건부(서버 nginx·배포 Smoke 🙋) |
