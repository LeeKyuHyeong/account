...
|---|---|---|---|---|---|---|---|
| O-001 | OPEN | Push | 푸시 설정 화면 세션 만료 처리 — 실제 브라우저 확인과 운영 배포 | 카카오 로그인 필요(에이전트 불가), `fix/push-api-401` 미머지 | records/2026-09-19_push-api-session-expired §6 → main 머지 → 배포 Smoke | 2026-09-19 | |
